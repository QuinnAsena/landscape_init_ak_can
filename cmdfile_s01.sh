# launch_cf -A UCIE0001 -l walltime=18:00:00 --steps-per-node 2 --ppn 128 --nthreads 64 --mem 235GB -l job_priority=economy /glade/work/qasena/landscape_init_ak_can/cmdfile_s01.sh
